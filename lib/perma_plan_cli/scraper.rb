class PermaPlanCli::Scraper
    ...
    def self.scrape_books
        page = Nokogiri::HTML(open("https://bookshop.org/books?keywords=permaculture"))
        ...
        array_of_books.each do |book_square|
            ...
            if book_square.css("h2.font-serif-bold a")[0].attributes['href'].value != nil
                url = "https://bookshop.org/" + book_square.css("h2.font-serif-bold a")[0].attributes['href'].value 
            else
                url = nil
            end
